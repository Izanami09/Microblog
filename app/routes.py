...
from app.forms import LoginForm, RegsitrationForm, EditProfileForm, EmptyForm, PostForm, ResetPasswordRequestForm, ResetPasswordForm
...
def login():
    ...
    if form.validate_on_submit():
        ...
        flash('Login requester for user {}, remember_me={}'.format(form.username.data, form.remember_me.data))
